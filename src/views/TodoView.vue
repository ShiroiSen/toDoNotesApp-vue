...
const addItem = () => {
  ...
  saveToLocalStorage()
  dataToDo.value = { title: '', todo: '', date: '', time: '', priority: 'deferred', isPinned: 'false' }
}
...
<template>
    ...
    <div class="max-w-xl mx-auto flex flex-col justify-center mt-6">
        ...
        <input v-model="searchQuery" id="searchbox" type="text" placeholder="Search To Do by typing Title or Priority" class="border border-gray-500 rounded-lg p-2.5 text-gray-900"/>
    </div>
